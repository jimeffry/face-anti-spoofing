...
python convert_data_to_tfrecord.py --image-dir /wdc/LXY.data/img_celeba/img_detected --save-name train --dataset-name CelebA \
        --anno-file ./output/train.txt #app_pea_wal.txt
