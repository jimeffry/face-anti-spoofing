...
python convert_data_to_tfrecord.py --image-dir  /home/lxy/Develop/Center_Loss/git_prj/BaiduImageSpider/img_dw --save-name train --dataset-name Fruit \
        --anno-file ./output/app_pea_wal.txt
